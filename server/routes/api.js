...
router.get('/increase', async function (req, res, next) {
  const num = await new Promise(resolve => setTimeout(resolve, 1000));
  res.json({
    status: 'success',
    data: 5,
  })
...
router.get('/increase/:num', function (req, res, next) {
